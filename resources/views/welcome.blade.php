...
<body class="index-page">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>Sistem Manajemen Aset & Inventaris </h1>
            <p>Selamat datang di Portal Sistem Manajemen Aset & Inventaris SD Islam Tompokesan! <br> Pantau, catat, dan kelola aset & inventaris sekolah dengan sistem yang dirancang khusus untuk mendukung kebutuhan sekolah secara akurat dan efisien.</p>
            <div class="d-flex">
              <a href="{{ route('login') }}" class="btn-get-started">Login</a>
              <a href="https://youtu.be/eJpfV7IXA6Y?si=3k5CJuexUcNn8jZx" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
            </div>
          </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">AssetTrack</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
